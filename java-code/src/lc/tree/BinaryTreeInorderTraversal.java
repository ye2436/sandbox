 ...
 * Given a binary lc.tree, return the inorder traversal of its nodes' values.
 * For example:
 * Given binary lc.tree [1,null,2,3],
 *  1
 *   \
 *   2
 *   /
...
public class BinaryTreeInorderTraversal {
    ...
    // iterative - push all the nodes from left subtree to stack (if not null) until reach the bottom.
    //             pop out a node from the stack, visit it and then make the right the next node
    ...
    //  Revert the changes to restore original lc.tree.
