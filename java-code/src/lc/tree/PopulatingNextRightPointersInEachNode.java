 ...
 * You may assume that it is a perfect binary lc.tree (ie, all leaves are at the same level, and every parent has two children).
 * For example,
 * Given the following perfect binary lc.tree,
 *           1
 *         /  \
 *        2    3
 *       / \  / \
...
public class PopulatingNextRightPointersInEachNode {
    ...
    public void connect_my(TreeLinkNode root) {
        ...
        while (node.left != null) {
            ...
            TreeLinkNode prev = null; // right node of the previous lc.tree on the same level
            while (parent != null) {
                if (prev != null) {
