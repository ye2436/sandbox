 ...
 * Given a binary lc.tree, flatten it to a linked list in-place.
 * For example,
 * Given
 *      1
 *     / \
 ...
 *   / \   \
 *  3   4   6
 * The flattened lc.tree should look like:
 *  1
 *   \
 *    2
 *     \
 ...
 *            6
 * Hints:
 * If you notice carefully in the flattened lc.tree, each node's right child points to the next node of a pre-order traversal.
 */
