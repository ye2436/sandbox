...
public class LongestSubstringWithoutRepeatingCharacters {
    ...
    // Sliding Window
    // Keep track of the characters appeared. When dup found, move left window until the dup character.
    // * Better way - Keep the <character, index> pair. So when dup appears, move left directly to the dup index +1
    // * NOTE - left should be max(left, dup index +1). because it's possible that the dup index is smaller than the current left window
